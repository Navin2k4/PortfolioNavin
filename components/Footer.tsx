  ...
  return (
    <footer className="w-full pb-10 mb-[70px] md:mb-5" id="contact">
        ...
        <div className='flex mt-16 md:flex-row flex-col lg:px-40  justify-between items-center'>
            <p className='md:text-base text-small md:font-normal font-thin'>Copyright ©️ 2024 Navin Kumaran</p>
            <div className='flex items-center md:gap-3 mt-3 gap-6'>
                {socialMedia.map((profile)=>(
                    <div key={profile.id} className='w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 hover:bg-violet-500 transition-all duration-300 rounded-lg border border-black-300'>
